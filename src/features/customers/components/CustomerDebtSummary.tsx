...
export function CustomerDebtSummary({ customerId }: CustomerDebtSummaryProps) {
    ...
    <Card className="border-red-200 bg-red-50/50 dark:border-red-900/50 dark:bg-red-950/20">
      <CardContent className="p-4 space-y-3">
        <div className="flex items-center gap-2 text-red-600 dark:text-red-400">
          ...
          <span className="text-sm font-medium">Hutang Outstanding</span>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            dari {summary.activeDebtsCount} hutang aktif
          </p>
        </div>
        ...
        {summary.oldestDays !== null && (
          <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
            ...
            <span>Hutang terlama: <span className="font-medium text-foreground">{summary.oldestDays} hari</span></span>
          </div>
        )}
      </CardContent>
    </Card>
